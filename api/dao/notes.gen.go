...
func newNote(db *gorm.DB, opts ...gen.DOOption) note {
	...
	_note.Name = field.NewString(tableName, "name")
	_note.Description = field.NewString(tableName, "description")
	_note.Created = field.NewInt64(tableName, "created")
	_note.Completed = field.NewInt64(tableName, "completed")
	_note.Deadline = field.NewInt64(tableName, "deadline")
...
func (n *note) updateTableName(table string) *note {
	...
	n.Created = field.NewInt64(table, "created")
	n.Completed = field.NewInt64(table, "completed")
	n.Deadline = field.NewInt64(table, "deadline")
...
func (n *note) fillFieldMap() {
	...
	n.fieldMap["completed"] = n.Completed
	n.fieldMap["deadline"] = n.Deadline
}
