...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Fname = field.NewString(tableName, "fname")
	_user.Lname = field.NewString(tableName, "lname")
	_user.Subject = field.NewField(tableName, "subject")
	...
	_user.DefaultGroup = field.NewField(tableName, "default_group")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Fname = field.NewString(table, "fname")
	u.Lname = field.NewString(table, "lname")
	u.Subject = field.NewField(table, "subject")
	u.Email = field.NewString(table, "email")
	u.PasswordHash = field.NewString(table, "password_hash")
	u.ProfileImage = field.NewString(table, "profile_image")
	u.DefaultGroup = field.NewField(table, "default_group")
