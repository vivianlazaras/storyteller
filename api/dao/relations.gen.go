...
func newRelation(db *gorm.DB, opts ...gen.DOOption) relation {
	...
	_relation.Parent = field.NewField(tableName, "parent")
	_relation.Child = field.NewField(tableName, "child")
	_relation.Description = field.NewString(tableName, "description")
	_relation.ParentCategory = field.NewString(tableName, "parent_category")
	_relation.ChildCategory = field.NewString(tableName, "child_category")
...
func (r *relation) updateTableName(table string) *relation {
	...
	r.Parent = field.NewField(table, "parent")
	r.Child = field.NewField(table, "child")
	r.Description = field.NewString(table, "description")
	r.ParentCategory = field.NewString(table, "parent_category")
	r.ChildCategory = field.NewString(table, "child_category")
...
func (r *relation) fillFieldMap() {
	...
	r.fieldMap["child"] = r.Child
	r.fieldMap["description"] = r.Description
	r.fieldMap["parent_category"] = r.ParentCategory
	r.fieldMap["child_category"] = r.ChildCategory
}
