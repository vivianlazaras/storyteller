...
func newMoment(db *gorm.DB, opts ...gen.DOOption) moment {
	...
	_moment.ID = field.NewField(tableName, "id")
	_moment.Timeline = field.NewField(tableName, "timeline")
	_moment.Idx = field.NewInt64(tableName, "idx")
	_moment.Fragment = field.NewField(tableName, "fragment")
...
func (m *moment) updateTableName(table string) *moment {
	...
	m.Timeline = field.NewField(table, "timeline")
	m.Idx = field.NewInt64(table, "idx")
	m.Fragment = field.NewField(table, "fragment")
...
func (m *moment) fillFieldMap() {
	...
	m.fieldMap["id"] = m.ID
	m.fieldMap["timeline"] = m.Timeline
	m.fieldMap["idx"] = m.Idx
	m.fieldMap["fragment"] = m.Fragment
}
